...
if CLIENT then
    ...
    Hook.Add("think", "CreateSpawnMenuAfterLoad", function()
        ...
        local sendButton = GUI.Button(GUI.RectTransform(Vector2(1, 0.1), chatMenuList.Content.RectTransform), "Send Message", GUI.Alignment.TopRight, "GUIButtonSmall")
        ...
        -- AdminHelp Button
        local buttonAdmin = GUI.Button(GUI.RectTransform(Vector2(0.15, 0.05), frame.RectTransform, GUI.Anchor.BottomLeft), "ADMIN HELP", GUI.Alignment.TopRight, "GUIButtonSmall")
        --Normal Color
